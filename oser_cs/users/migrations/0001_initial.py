    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, max_length=12, null=True, verbose_name='téléphone')),
                ('profile_type', models.CharField(choices=[('student', 'Lycéen'), ('tutor', 'Tuteur'), ('schoolstaffmember', 'Personnel de lycée')], max_length=20, verbose_name='type de profil')),
            ],
            options={
                'verbose_name': 'user',
