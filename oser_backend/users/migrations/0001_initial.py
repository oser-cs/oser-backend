    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.CharField(choices=[('student', 'Lycéen'), ('tutor', 'Tuteur'), ('schoolstaffmember', 'Membre du personnel de lycée')], max_length=20, verbose_name='type de profil')),
            ],
            options={
                'verbose_name': 'user',
